...
import { Member, Transaction, MemberLoanSummary } from "../types";
import {
  ShieldCheck,
  QrCode,
  Edit2,
...
interface MemberProfileProps {
  ...
  loanSummary?: MemberLoanSummary | null;
}
    ...
    <div className="space-y-8 animate-fade-in pb-12 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div
            className="relative w-full max-w-md lg:max-w-none mx-auto aspect-[1.586/1] perspective-1000 group cursor-pointer"
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-emerald-300/80 font-medium tracking-wider uppercase mt-1">
                            Official Member
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-end gap-4">
                        <div className="flex-1">
                          <p className="text-[10px] text-emerald-300 uppercase font-bold tracking-widest mb-1">
                            Member Name
                          </p>
                          <p className="text-xl md:text-2xl font-bold text-white tracking-wide truncate">
                            {member.fullName}
                          </p>
                        </div>
                        <div className="shrink-0 text-right">
                          ...
                          <span
                            className={`inline-flex items-center px-2.5 py-1 rounded-lg text-[10px] font-bold uppercase border ${
                      ...
                      <div className="flex justify-between items-end pt-4 border-t border-white/10">
                        <div>
                          <p className="text-[9px] text-emerald-400 uppercase font-bold tracking-widest mb-0.5">
                            Member ID
                          </p>
                    ...
                    <div className="flex justify-between items-start gap-4">
                      <div className="flex-1">
                        ...
                        <div className="bg-white/90 h-10 w-full mb-3 flex items-center justify-start px-2 relative pattern-dots">
                          <div
                            className="text-gray-400 font-handwriting text-lg italic opacity-70 ml-2"
                        ...
                        <p className="text-[9px] text-gray-400 leading-tight">
                          This card is non-transferable and remains the property
                          of Satja Savings Ban Sai Yai Group. Please return if
                          found.
                        </p>
                      </div>
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 max-w-md lg:max-w-none mx-auto w-full">
            ...
            <div className="w-full bg-gray-100 rounded-full h-2 mb-4 overflow-hidden flex">
              <div
                ...
                style={{
                  width: `${(member.shareBalance / totalWealth) * 100}%`,
                }}
              ></div>
              <div
                className="bg-emerald-500 h-full"
                style={{
                  width: `${(member.savingsBalance / totalWealth) * 100}%`,
                }}
              ></div>
            </div>
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div className="p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">
              <InfoItem
                ...
                value={maskIdCard(member.idCardNumber || "")}
                mono
              />
              <InfoItem
                icon={Calendar}
                ...
                subValue={`Age: ${calculateAge(member.birthDate)} Years`}
              />
              <InfoItem
                icon={Briefcase}
                label="Occupation"
              ...
              <InfoItem
                ...
                value={`฿${(member.monthlyIncome || 0).toLocaleString()}`}
              />
            </div>
          </div>
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
              <div className="p-6 border-b border-gray-50 bg-gray-50/50 flex items-center justify-between">
                ...
                >
                  {loanSummary.isEligibleForLoan ? (
                    <>
                      <CheckCircle className="w-3.5 h-3.5" /> Eligible for Loan
                    </>
                  ) : (
                    <>
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                  ...
                  <div className="bg-gray-50 rounded-xl p-4 text-center">
                    <p className="text-2xl font-bold text-emerald-600">
                      ฿{loanSummary.totalPaid.toLocaleString()}
                    </p>
                ...
                {/* Active Loans List */}
                {loanSummary.loans &&
                  loanSummary.loans.filter((l) => l.status === "ACTIVE")
                    .length > 0 && (
                    <div>
                            ...
                            >
                              <div>
                                ...
                                <p className="text-xs text-gray-500">
                                  {loan.loanType} • Started {loan.startDate}
                                </p>
                              </div>
                              <div className="text-right">
