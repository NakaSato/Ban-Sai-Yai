 ...
 * Provides methods for querying audit logs with custom queries for critical
...
public interface AuditLogRepository extends JpaRepository<AuditLog, Long> {
        ...
        * These are logged when users attempt to access resources without
        * authorization.
        *
        ...
        * @param startTime the start time
        * @param endTime   the end time
        * @return the count of audit logs in the time range
        */
       ...
       /**
        * Count critical actions within a time range.
        *
        * @param startTime the start time
        * @param endTime   the end time
        * @return the count of critical actions in the time range
        */
       @Query("SELECT COUNT(a) FROM AuditLog a WHERE (a.action LIKE '%DELETE%' OR a.action LIKE '%OVERRIDE%') " +
                     "AND a.timestamp BETWEEN :startTime AND :endTime")
       long countCriticalActions(@Param("startTime") LocalDateTime startTime, @Param("endTime") LocalDateTime endTime);

       /**
        * Count role violations within a time range.
        *
        * @param startTime the start time
        * @param endTime   the end time
        * @return the count of role violations in the time range
        */
