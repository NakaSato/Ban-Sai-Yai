...
public class InputSanitizer {
  ...
  private static final Pattern SQL_INJECTION_PATTERN = Pattern.compile(
      "(--|;|'|\"|\\/\\*|\\*\\/|xp_|exec|execute|insert|select|delete|update|drop|create|alter|union|into|load_file|outfile)",
  ...
  public boolean isValidPhone(String phone) {
    ...
    return digits.length() >= 9 && digits.length() <= 10 && PHONE_PATTERN.matcher(phone).matches();
  }
