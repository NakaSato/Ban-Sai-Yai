...
public class PaymentService {
  ...
  public PaymentResponse createPayment(PaymentRequest request, String createdBy) {
    ...
    request.setDescription(inputSanitizer.sanitizeText(request.getDescription()));
    request.setNotes(inputSanitizer.sanitizeText(request.getNotes()));
    request.setReferenceNumber(inputSanitizer.sanitizeText(request.getReferenceNumber()));
    request.setReceiptNumber(inputSanitizer.sanitizeText(request.getReceiptNumber()));
    request.setBankAccount(inputSanitizer.sanitizeText(request.getBankAccount()));
